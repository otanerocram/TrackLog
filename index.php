        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-8 col-md-7 py-4">
              ...
              <p class="text-muted">En la columna "Estado" se muestran los códigos de respuesta recibidos por el webservice</p>
            </div>
...
$result = mysqli_query($con,"SELECT `posicionId`, `vehiculoId`, `velocidad`, `satelites`, `rumbo`, `latitud`, `longitud`, `altitud`, `gpsDate`, `gpsTime`, `statusCode`, `ignition`, `odometro`, `horometro`, `nivelBateria`, `estado` FROM `TrackLog` ORDER BY `posicionId` DESC LIMIT 100;");
...
echo "<td>" . $row['gpsDate'] ." ". $row['gpsTime'] ."</td>";
